...
import ds.service1.Service1Discovery;
import ds.service2.Service2Discovery; // Import for Service2 Discovery
...
public class ControllerGUI implements ActionListener {
    ...
    private void discoverServices() {
        // Discover service1
        Service1Discovery discovery1 = new Service1Discovery();
        discovery1.discoverService();
        //Discover service2
        Service2Discovery discovery2 = new Service2Discovery();
        discovery2.discoverService();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            if (label.equals("Activate Horn")) {
                ...
                channel = ManagedChannelBuilder.forAddress("localhost", 50051).usePlaintext().build();///////////Service1Host ////Service1Port////////
                ...
                if (points.length == 2) {
                    ...
                    TrafficRequest request = TrafficRequest.newBuilder()
                            ...
                            .build();
                    ///////////////////respond from the stream server list below ///////////////////
