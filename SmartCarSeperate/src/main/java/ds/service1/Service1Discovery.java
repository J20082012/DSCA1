...
public class Service1Discovery {
    ...
    private class SampleListener implements ServiceListener {
        ...
        public void serviceResolved(ServiceEvent event) {
            System.out.println("Service resolved: " + event.getInfo()+event.getName());
    ...
    public void discoverService() {
        try {
            ...
            Logger.getLogger(Service1Discovery.class.getName()).log(Level.SEVERE, e.getMessage(), e);
        }
    }
    ...
    public static void main(String[] args) {
        Service1Discovery service1Discovery = new Service1Discovery();
        service1Discovery.discoverService();

        // Check if the service was discovered successfully
        boolean isDiscovered = service1Discovery.isServiceDiscovered();
